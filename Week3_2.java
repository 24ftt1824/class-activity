...
public class Week3_2 {
    ...
    public static void main(String[] args) {
        ...
        // initialize
            ...
            // //String name= input.next(); (for 1 word only no 2 words unless no space)
            ...
            System.out.printf("%.2f%n",duitu);
            System.out.printf("%.3f%n",duitu);
            System.out.printf("%.0f%n",duitu);
